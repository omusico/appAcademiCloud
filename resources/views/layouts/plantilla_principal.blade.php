...
<body class="fixed-header   ">
    ...
    <div class="page-sidebar" data-pages="sidebar">
        ...
        <div class="sidebar-header">
            <img src="{{ asset('frontend/assets/img/logo_white2.png') }}" alt="logo" class="brand" data-src="{{ asset('frontend/assets/img/logo_white2.png') }}" data-src-retina="{{ asset('frontend/assets/img/logo_white2_2x.png') }}" width="78" >
                ...
                <div class="header-inner">
                    ...
                    <ul class="notification-list no-margin hidden-sm hidden-xs b-grey b-l b-r no-style p-l-30 p-r-20">
                        <li class="p-r-15 inline">
                            <a href="{!! url('inicio') !!}" class="glyphicon glyphicon-home"></a>
                        </li>
                        <li class="p-r-15 inline">
                            <a href="javascript:void(0)" class="glyphicon glyphicon-search" data-toggle="search"></a>
                        </li>
                        <li class="p-r-15 inline">
                            <a href="{!! url('cerrar_sesion') !!}" class="glyphicon glyphicon-off"></a>
                        </li>
                    </ul>
                    <!-- END NOTIFICATION DROPDOWN -->
                    <span class="search-link" ><i class="fa fa-home"></i>
                        @if (Session::has('ses_ie_denominacion'))
                            {{ Session::get('ses_ie_denominacion') }}
                        @endif
                    </span>
                    ...
                    <div class="dropdown pull-right">
                        <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="thumbnail-wrapper d32 circular inline m-t-5">
                                @if (Session::has('ses_usuario_avatar'))
                                    <img src="{{ asset('media/ui_avatares_usuarios/' . Session::get('ses_usuario_avatar')) }}" alt="" data-src="{{ asset('media/ui_avatares_usuarios/' . Session::get('ses_usuario_avatar')) }}" data-src-retina="{{ asset('media/ui_avatares_usuarios/ ' . Session::get('ses_usuario_avatar')) }}" width="32" height="32">
                                @endif
                            </span>
                        </button>
                        <ul class="dropdown-menu profile-dropdown" role="menu">
                            <li><a href="#"><i class="pg-settings_small"></i> Perfil</a>
                            </li>
                            <li><a href="#"><i class="pg-outdent"></i> Logs</a>
                            </li>
                            <li><a href="{{ url('usuario/actualizacion_clave') }}"><i class="fa fa-unlock"></i> Cambiar Clave de Acceso</a>
                            </li>
                            <li class="bg-master-lighter">
                                <a href="{!! url('cerrar_sesion') !!}" class="clearfix">
    ...
    <div class="overlay" style="display: none" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                <!-- BEGIN Overlay Logo !-->
                <img class="overlay-brand" src="{{ asset('frontend/assets/img/logo_academicloud.png') }}" alt="logo" data-src="{{ asset('frontend/assets/img/logo_academicloud.png') }}" data-src-retina="{{ asset('frontend/assets/img/logo_academicloud2x.png') }}" width="78" height="22">
                <!-- END Overlay Logo !-->
                <!-- BEGIN Overlay Close !-->
