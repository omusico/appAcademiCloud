        ...
        <div class="content">
            <div class="jumbotron bg-success-dark" data-pages="parallax">
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                    <div class="inner">
                        <h5 class="text-white"><i class="fa fa-cogs"></i> Seguridades / <span class="semi-bold">Módulos de Sistema</span>
                            <div class="pull-right" style="margin-right: 20px">
                                <a href="{{ url('seguridades/grupos_opciones') }}" class="btn btn-default btn-xs"><i class="fa fa-undo"></i> Regresar</a>
                                <a href="{{ url('seguridades/modulos_sistema/crear/' .  Crypt::encrypt($grupo->grupo_opciones_id)) }}" class="btn btn-default btn-xs"><i class="fa fa-plus-square"></i> Crear Nuevo</a>
                            </div>
                        </h5>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        <h5>Grupo: <strong>{!! $grupo->denominacion !!}</strong></h5>
                        {!!
                        Datatable::table()
                            ->addColumn('#', 'Denominación', 'Controlador / Acción', '')
                            ->setUrl(URL::to('seguridades/modulos_sistema/buscar_registros_dt' . '/' . Crypt::encrypt($grupo->grupo_opciones_id)))
                            ->noScript()
                            ->render('seguridades.catalogos.modulos_sistema.dt_template')
                        !!}
                    </div>
                </div>
