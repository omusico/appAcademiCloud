        ...
        <div class="content">
            <div class="jumbotron bg-success-dark" data-pages="parallax">
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                    <div class="inner">
                        <h5 class="text-white"><i class="fa fa-cogs"></i> Seguridades / <span class="semi-bold">Grupos de Opciones</span> / Eliminar</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::open(array('url' => 'seguridades/grupos_opciones/grabar_eliminar', 'id' => 'frm_data')) !!}
