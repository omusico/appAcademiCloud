        ...
        <div class="content">
            <div class="jumbotron bg-success-dark" data-pages="parallax">
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                    <div class="inner">
                        <h5 class="text-white"><i class="fa fa-cogs"></i> Seguridades / <span class="semi-bold">Roles</span>
                            <div class="pull-right" style="margin-right: 20px">
                                <a href="{{ url('seguridades/roles/crear') }}" class="btn btn-default btn-xs"><i class="fa fa-plus-square"></i> Crear Nuevo</a>
                            </div>
                        </h5>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel ">
                            ...
                            <div class="panel-body">
                                {!!
                                Datatable::table()
                                    ->addColumn('Subsistema', 'Denominación', 'Estado', '')
                                    ->setUrl(URL::to('seguridades/roles/buscar_registros_dt'))
                                    ->noScript()
                                    ->render('seguridades.catalogos.roles.dt_template')
                                !!}
                            </div>
                        </div>
